...
public class MainActivity extends AppCompatActivity {
    ...
    int b1=5,b2=5,b3=5,b4=5,b5=5,b6=5,b7=5,b8=5,b9=5,xcount=0,ocount=0;
    ...
    private void winningGame(){
        if((b1==1)&& (b2==1)&&(b3==1)){
            ...
            alertDialog.show();
            xcount++;
            scorex.setText("Score X :-"+String.valueOf(ocount));
            ...
            int m;
            m=i;
            System.out.println(i+" outer loop "+m);

            if(m==9){
                System.out.println(i+" inner loop "+m);
                AlertDialog.Builder builder=new AlertDialog.Builder( this);
